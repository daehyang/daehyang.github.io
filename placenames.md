...
이 번호를 **대전향토문화 번호**라 하며, `DHC-부여연도-일련번호` 꼴입니다.
...
- **[GitHub 저장소](https://github.com/daehyang)의 이슈** — 계정이 있으시면 근거가
  되는 문헌을 적어 남기실 수 있습니다.
- **회원을 통해 정기 회의 안건으로** 올려 주셔도 됩니다.

근거가 되는 문헌이 있으면 책 이름과 쪽수까지 함께 알려주시면 큰 도움이 됩니다.
